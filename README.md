...
<img width="400" alt="Chart showing speed of HTML minifiers" src="https://wilsonl.in/minify-html/bench/0.8.5/core/average-speeds.png"><img width="400" alt="Chart showing compression of HTML minifiers" src="https://wilsonl.in/minify-html/bench/0.8.5/core/average-sizes.png">
...
[Linux x64](https://wilsonl.in/minify-html/bin/0.8.5-linux-x86_64) |
[Linux ARM64](https://wilsonl.in/minify-html/bin/0.8.5-linux-arm64) |
[macOS x64](https://wilsonl.in/minify-html/bin/0.8.5-macos-x86_64) |
[macOS ARM64](https://wilsonl.in/minify-html/bin/0.8.5-macos-arm64) |
[Windows x64](https://wilsonl.in/minify-html/bin/0.8.5-windows-x86_64.exe)
...
```toml
[dependencies]
minify-html = { version = "0.8.5", features = ["js-esbuild"] }
```
